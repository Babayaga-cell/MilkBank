        ...
        <ul>
          ...
          <?php
            ...
            if(isset($_SESSION['userID'])){
                echo'  <li><a href="#donatemilk">Donate Milk</a></li>
                <li><a href="#reservemilk">Reserve Milk</a></li>
                <li class="drop-down"><a href="UserProfile.php">Profile</a>
                <ul>
                <li><center><form action="BackEnd/logout.be.php" method = "POST">
                <button type="submit" class="btn btn-link" name="logout-submit">Logout</button>
                </form></center></li>
                </ul>';
            }
            else{
